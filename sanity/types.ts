...
// Query: *[_type == "blog" && _id == $id][0]{  _id,   title,   slug,   _createdAt,   description,   author -> {_id, name, username, bio, image},  views,   description,    category,    image,    pitch}
...
// Variable: BLOG_VIEWS_QUERY
// Query: *[_type == "blog" && _id == $id][0]{      _id, views  }
export type BLOG_VIEWS_QUERYResult = {
  _id: string;
  views: number | null;
} | null;
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == \"blog\" && defined(slug.current) && !defined($search) || category match $search || author->name match $search || title match $search] | order(_createdAt desc) {\n  _id, \n  title, \n  slug, \n  _createdAt, \n  description, \n  author -> {_id, name, bio, image},\n  views, \n  description,\n  category,\n  image\n}": BLOGS_QUERYResult;
